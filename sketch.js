...
function preload(){
  ...
  bulletegg = loadAnimation("assets/bulletegg.png")
  crashegg = loadAnimation("assets/crashegg.png")
...
if(keyWentDown("space")){
  ...
  bullet.velocityX = 20
  bullet.addAnimation("huevo",bulletegg)
  bullet.addAnimation("broken", crashegg)
  bullet.scale= 0.05
